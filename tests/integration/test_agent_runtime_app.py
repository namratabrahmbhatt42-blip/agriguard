...
# Gracefully skip these tests if Google Cloud / Vertex AI environment is not configured
try:
    from app.agent_runtime_app import AgentEngineApp
except Exception as e:
    AgentEngineApp = object  # Placeholder type
    pytestmark = pytest.mark.skip(
        reason=f"Google Cloud credentials or Vertex AI not initialized: {e}"
    )
